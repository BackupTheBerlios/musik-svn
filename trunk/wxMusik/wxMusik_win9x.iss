...
#define MyAppVer GetFileVersion("Build\Release\" + MyAppName + ".exe") ; define variable
...
[Files]
Source: Build\Release\{#MyAppExe}; DestDir: {app}; Flags: promptifolder replacesameversion; MinVersion: 4.1.1998,0; OnlyBelowVersion: 4.90.3000,0
Source: changelog.txt; DestDir: {app}; Flags: ignoreversion
;Source: Release Unicode\BlackBox.dll; DestDir: {app}; Flags: ignoreversion
Source: Build\Release\fmod.dll; DestDir: {app}; Flags: replacesameversion
Source: license.txt; DestDir: {app}; Flags: ignoreversion
Source: Build\Release\MMShellHook.dll; DestDir: {app}; Flags: replacesameversion
