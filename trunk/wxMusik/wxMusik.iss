...
#define MyAppVer GetFileVersion("Build\Release Unicode\" + MyAppName + ".exe") ; define variable
...
AppCopyright=© 2007, Gunnar Roth, Casey Langen, Simon Windmill
...
Source: Build\Release Unicode\fmod.dll; DestDir: {app}; Flags: replacesameversion
Source: license.txt; DestDir: {app}; Flags: ignoreversion
Source: Build\Release Unicode\MMShellHook.dll; DestDir: {app}; Flags: replacesameversion
...
Source: Build\Release Unicode\{#MyAppExe}; DestDir: {app}; MinVersion: 0,5.0.2195; Flags: promptifolder replacesameversion
