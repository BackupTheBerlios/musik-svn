...
MPC_decoder::Huffman_SV6_Decoder ( void )
{
    ...
    Resort_HuffTables(  3, Entropie_1    , Dc7[1]);
    Resort_HuffTables(  5, Entropie_2    , Dc7[2]);
    Resort_HuffTables(  7, Entropie_3    , Dc7[3]);
    Resort_HuffTables(  9, Entropie_4    , Dc7[4]);
    Resort_HuffTables( 15, Entropie_5    , Dc7[5]);
    Resort_HuffTables( 31, Entropie_6    , Dc7[6]);
    Resort_HuffTables( 63, Entropie_7    , Dc7[7]);
}
