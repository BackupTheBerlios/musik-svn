...
#define FMOD_VERSION    0x00040451
...
[
    ...
    [REMARKS]
    By default a sound will open as a static sound that is decompressed fully into memory. (ie equivalent of FMOD_CREATESAMPLE)<br>
