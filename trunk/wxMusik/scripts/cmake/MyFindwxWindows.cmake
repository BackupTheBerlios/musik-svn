...
#    ENDIF(CMAKE_BUILD_TYPE STREQUAL Debug)
	...
	SET(WX_CONFIG_ARG_UNICODE "--unicode=yes")
      ELSE(WXWINDOWS_USE_UNICODE)
        SET(WX_CONFIG_ARG_UNICDOE "--unicode=no")
      ENDIF(WXWINDOWS_USE_UNICODE)

      IF(WXWINDOWS_USE_DEBUG)
	SET(WX_CONFIG_ARG_DEBUG "--debug=yes")
      ELSE(WXWINDOWS_USE_DEBUG)
        SET(WX_CONFIG_ARG_DEBUG "--debug=no")
      ...
      SET(WX_CONFIG_ARGS_LIBS "${WX_CONFIG_ARG_UNICODE} ${WX_CONFIG_ARG_DEBUG}")
      IF(WXWINDOWS_USE_SHARED_LIBS)
        SET(WX_CONFIG_ARGS_LIBS "${WX_CONFIG_ARGS_LIBS} --libs")
      ELSE(WXWINDOWS_USE_SHARED_LIBS)
        SET(WX_CONFIG_ARGS_LIBS "${WX_CONFIG_ARGS_LIBS} --static --libs")
      ENDIF(WXWINDOWS_USE_SHARED_LIBS)
      ...
      SET(CMAKE_WXWINDOWS_CXX_FLAGS "`${CMAKE_WXWINDOWS_WXCONFIG_EXECUTABLE} ${WX_CONFIG_ARG_UNICODE} ${WX_CONFIG_ARG_DEBUG} --cxxflags`")
...
#     IF(APPLE)
#        EXEC_PROGRAM(${CMAKE_WXWINDOWS_WXCONFIG_EXECUTABLE}
#            ARGS ${WX_CONFIG_ARG_UNICODE} ${WX_CONFIG_ARG_DEBUG} --rezflags 
#            OUTPUT_VARIABLE WXWINDOWS_APPLE_REZ_COMMAND )
#     ENDIF(APPLE) 
