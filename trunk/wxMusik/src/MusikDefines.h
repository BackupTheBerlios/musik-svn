...
const int wxADJUST_MINSIZE = 0; //dummy this flag i not used in 2.8.3 anymore
#endif
...
enum EMUSIK_MENU_ITEMS
{
	...
	MUSIK_PLAYLIST_CONTEXT_SHOW_IN_LIBRARY_FIRST_ENTRY,
	MUSIK_PLAYLIST_CONTEXT_SHOW_IN_LIBRARY_LAST_ENTRY= MUSIK_PLAYLIST_CONTEXT_SHOW_IN_LIBRARY_FIRST_ENTRY + ActivityBoxesMaxCount - 1,
	...
	MUSIK_PLAYLIST_DISPLAY_LAST = MUSIK_PLAYLIST_DISPLAY_FIRST + PlaylistColumn::NCOLUMNS - 1,
