...
#define MyAppVer GetFileVersion("_release\" + MyAppName + ".exe") ; define variable
...
[Files]
Source: _release\{#MyAppExe}; DestDir: {app}; Flags: promptifolder replacesameversion; MinVersion: 4.1.1998,0; OnlyBelowVersion: 4.90.3000,0
Source: changelog.txt; DestDir: {app}; Flags: ignoreversion
;Source: Release Unicode\BlackBox.dll; DestDir: {app}; Flags: ignoreversion
Source: _release\fmod.dll; DestDir: {app}; Flags: replacesameversion
