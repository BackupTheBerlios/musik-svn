...
MPC_decoder::Huffman_SV7_Decoder ( void )
{
    ...
    Resort_HuffTables( 7, &HuffQ3[0][0] , Dc7[3]);
    Resort_HuffTables( 7, &HuffQ3[1][0] , Dc7[3]);
    Resort_HuffTables( 9, &HuffQ4[0][0] , Dc7[4]);
    Resort_HuffTables( 9, &HuffQ4[1][0] , Dc7[4]);
    Resort_HuffTables(15, &HuffQ5[0][0] , Dc7[5]);
    Resort_HuffTables(15, &HuffQ5[1][0] , Dc7[5]);
    Resort_HuffTables(31, &HuffQ6[0][0] , Dc7[6]);
    Resort_HuffTables(31, &HuffQ6[1][0] , Dc7[6]);
    Resort_HuffTables(63, &HuffQ7[0][0] , Dc7[7]);
    Resort_HuffTables(63, &HuffQ7[1][0] , Dc7[7]);
}
